            ...
            data === null ? (
              ...
              allPackages.length === 0 ? (
                <div className={styles.noFound}>
                  ...
                  <div> <h3>There are no items matching your search.</h3><ul><li><strong>Check the grammar</strong> of the word.</li><li>Use <strong>more generic words</strong> or fewer words.</li><li><a href="/packages"> Browse our packages </a>
