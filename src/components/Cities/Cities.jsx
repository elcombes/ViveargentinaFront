                ...
                loading ? (
                  ...
                  allCities?.length === 0 ? (
                    <div className={styles.noFound}>
                      ...
                      <div> <h3>There are no items matching your search.</h3><ul><li><strong>Check the grammar</strong> of the word.</li><li>Use <strong>more generic words</strong> or fewer words.</li><li><a href="/cities"> Browse our cities </a>
                        to find a similar product</li></ul></div>
                    </div>
                  ) : (
                    <div class="accordion accordion-flush" id="accordionFlushExample">
                      {allCities?.map((e) => {
                        return (<div class="accordion-item" key={prevId++}>
                          {/* INICIO ITEM */}
