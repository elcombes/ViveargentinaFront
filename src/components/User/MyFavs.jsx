                    ...
                    <div className="col-md-12">
                      <div className={`row mt-3 mb-3 ${styles.itemmyfavs}`}>
                        ...
                        <div className="col-md-1">
                          <img src={p.image} alt="" className={`img-fluid ${styles.imgfavprofile}`} />
                        </div>
